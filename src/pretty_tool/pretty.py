...
def main():
    ...
    parser.add_argument("input_file", help="Path to the input file", default=None, nargs='?')
    parser.add_argument(
    ...
    if args.language is None:
        raise argparse.ArgumentError(args.language, message='You need to select a language code!')
    
    if args.input_file is None:
        raise argparse.ArgumentError(args.input_file, message='You need to select an input file!')
